...
const HeroCarousel = () => {
  ...
  return (
    <section className="relative min-h-[40vh] md:min-h-[60vh] lg:min-h-[75vh] overflow-hidden">
      <Carousel 
        setApi={setApi}
        opts={{
          align: "start",
        ...
        <CarouselContent className="-ml-0">
          {slides.map((slide) => (
            <CarouselItem key={slide.id} className="pl-0">
              <div className="relative min-h-[40vh] md:min-h-[60vh] lg:min-h-[75vh] flex items-center bg-gradient-hero overflow-hidden">
                {/* Background Image */}
