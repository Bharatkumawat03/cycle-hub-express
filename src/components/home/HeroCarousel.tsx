...
const HeroCarousel = () => {
  ...
  return (
    <section className="relative min-h-[50vh] md:min-h-[70vh] lg:min-h-[85vh] overflow-hidden">
      <Carousel 
        setApi={setApi}
        opts={{
          align: "start",
        ...
        <CarouselContent className="-ml-0">
          {slides.map((slide) => (
            <CarouselItem key={slide.id} className="pl-0">
              <div className="relative min-h-[50vh] md:min-h-[70vh] lg:min-h-[85vh] flex items-center bg-gradient-hero overflow-hidden">
                {/* Background Image */}
